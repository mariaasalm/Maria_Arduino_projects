...
<body>
  ...
  <p>
    ...
    <p>
    <i class="fas fa-thermometer-half" style="color:#059e8a;"></i> 
    <span class="dht-labels">Body Temperature</span> 
    ...
    <span id="beatsPerMin">%BeatsPerMin%</span>
...
setInterval(function ( ) {
  ...
  xhttp.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      document.getElementById("beatsPerMin").innerHTML = this.responseText;
    }
  };
  xhttp.open("GET", "/beatsPerMin", true);
  xhttp.send();
}, 10000 ) ;
</script>
</html>)rawliteral";